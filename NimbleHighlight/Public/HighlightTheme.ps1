...
# (For full theming there would probably also be a single background color, 
# and set/reset at the top level)
# Note too that show-token performs some more specific color overwrites
# for quotes around strings, and comment hashes.
#
